public class TypeCheckVisitor extends DepthFirstVisitor{  
    ...
    public void visit(Iden n){
        ...
        //System.out.println("TypeCheckVisitor * Id * " + n.s.toString());
    ...
    public void visit(ModInt n){
        ...
        String c = n.a.s.toString();
        System.out.println("ModuleInterface Class "+c+" ");
        
        currClass = symbolTable.getClass(c);                
    ...
    public void visit(ModImp n){
        ...
        //n.a.accept(this); // Iden
        String c = n.a.s.toString();
        System.out.println("ModuleImplementation Class "+c+" ");
        currClass = symbolTable.getClass(c); 
...
//    System.out.println("GenericFunctionDecl "+id);
        if (n.c!=null) n.c.accept(this); //TypPar
        n.d.accept(this);                //ForPar
        if (n.e!=null) n.e.accept(this); // ; | Bloc
//    if (symbolTable.compareTypes(retType, retStaType)==false){
...
//    }        
    ...
    public void visit(VarDec n){
        n.a.accept(this); // Type
        n.b.accept(this); // Iden
        System.out.println("VariableDecl "+n.b.s.toString());
    ...
    public void visit(Para n){
        n.a.accept(this); // Type
        n.b.accept(this); // Iden
        System.out.println("FormalParameter "+n.b.s.toString());
    }
    ...
    public void visit(ClaDec n){
        ...
        //n.a.accept(this);                // iden
        String c = n.a.s.toString();
        System.out.println("ClassDecl Class "+c+"");
        currClass = symbolTable.getClass(c);          
    ...
    public void visit(IntDec n){
        ...
        //n.a.accept(this);                 // iden
        String c = n.a.s.toString();
        System.out.println("InterfaceDecl Class "+c+" ");
        currClass = symbolTable.getClass(c);          
    ...
    public void visit(FunTyp n){
        ...
        //n.b.accept(this);  // Iden
        String c = n.b.s.toString();
        System.out.println("FunctionTypeDecl Class "+c+" ");
        currClass = symbolTable.getClass(c);  
    ...
    System.out.println("ConstructorDecl Method "+id);
    currMethod = currClass.getMethod(id);
//    Type retType = currMethod.type();        
...
//    String id = n.c.s.toString();
//    System.out.println("FunctionMethod Method "+id);
//    currMethod = currClass.getMethod(id);
//    Type retType = currMethod.type();
...
//    }        
    ...
    public void visit(LVD n){
        n.a.accept(this);                // Type
        n.b.accept(this);                // Iden
        System.out.println("LocalVariableDecl "+n.b.s.toString());
    ...
    public void visit(AsiSta n){
        ...
        System.out.println("CheckType AsignmentStat ");
//    Type t1 = symbolTable.getVarType(currMethod,currClass,n.a.toString());
//    Type t2 = n.b.accept(new TypeCheckExpVisitor());
//    if (symbolTable.compareTypes(t1,t2)==false){
//	System.out.println("Type error in assignment to "+n.a.toString());	
//	System.exit(0);
//    }
    ...
    public void visit(RetSta n){
        n.a.accept(this); // Expr
        retStaType=n.a.accept(new TypeCheckExpVisitor());
    }
