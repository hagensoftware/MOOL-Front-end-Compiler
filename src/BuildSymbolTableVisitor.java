public class BuildSymbolTableVisitor extends TypeDepthFirstVisitor{
    ...
    public Type visit(Iden n){
        ...
        //System.out.println("TBuildSymbolTableVisitor * Id * " + n.s.toString());
        return null;
    }
    ...
    public Type visit(Prog n){
        ...
        System.out.println("End SymbolTable**********************");
        return null;
    }
    ...
    public Type visit(ModInt n){
       symbolTable = new SymbolTable();
       System.out.println("Interface SymbolTable****************");
                          // module interface
//        n.a.accept(this); // Iden

     Type t = new TypVoi(true); //null; // n.b.accept(this);
     String id =  n.a.s.toString();
     
     parent=id;
        
        
        if(!symbolTable.addClass( id, "MODINT")){
        	System.out.println("Interface " +  id + " is already defined" ); 
	        System.exit(-1);
        }
     System.out.println("addClass ModuleInterface "+id);
    ...
    public Type visit(ModImp n){
       symbolTable = new SymbolTable();
       System.out.println("Implementation SymbolTable***********");
                          // module
//        n.a.accept(this); // Iden
        Type t = new TypVoi(true); //null; // n.b.accept(this);
        String id =  n.a.s.toString();
        ...
        if(!symbolTable.addClass( id, null)){
        	System.out.println("Module Implementation " +  id + " is already defined" ); 
	        System.exit(-1);
        }
        System.out.println("addClass ModuleImplementation "+id);
        currClass =  symbolTable.getClass(id);
...
//        n.b.accept(this);  //Iden
        System.out.println("addVar ConDec "+n.b.s.toString() );
     Type t =  n.a.accept(this);
     String id =  n.b.s.toString();
...
//        n.b.accept(this);                //Iden
	...
	System.out.println("GenericFunction Method " + id 
			   + " is already defined in " 
			   + currClass.getId()); 
	System.exit(-1);
    }
    System.out.println("addMethod GFD "+id );
...
//        n.b.accept(this); // Iden
     ...
     System.out.println("addVar VarDec "+id);
    //return null;        
	...
	System.out.println("Formal parameter " + id + " is already defined in " 
			   + currClass.getId() + "." +
			   currMethod.getId());
	System.exit(-1);
    }
    System.out.println("addParam FormalParameter "+id );
    return null;        
    ...
    public Type visit(ClaDec n){
        ...
        if(!symbolTable.addClass( n.a.s.toString(), parent)){
        	System.out.println("Class " +  n.a.s.toString() + " is already defined" ); 
	        System.exit(-1);
        }
        System.out.println("addClass Class "+n.a.s.toString()+" to "+parent);
        currClass =  symbolTable.getClass(n.a.s.toString());
    ...
    public Type visit(IntDec n){
                                          // class interface
        n.a.accept(this);                 // iden
        System.out.println("addClass InterfaceDecl "+n.a.s.toString()+" to "+parent);
        
        if(!symbolTable.addClass( n.a.s.toString(), parent)){
        	System.out.println("Interface " +  n.a.s.toString() + " is already defined" ); 
	        System.exit(-1);
        }
        currClass =  symbolTable.getClass(n.a.s.toString());
    ...
    public Type visit(FieDec n){
     ...
     Type t =  n.a.accept(this);
     String id =  n.b.s.toString();
     System.out.println("addVar FieldDecl "+id );
...
//        n.a.accept(this);                // Iden
    Type t = null; //n.a.accept(this);
    String id = n.a.s.toString();
    System.out.println("addMethod ConstructorDecl "+id );
    if (!currClass.addMethod(id,t)){
...
//        n.c.accept(this);                // Iden
    ...
    Type t = n.b.accept(this);      // Type | void
    String id = n.c.s.toString();   // Iden
    
    System.out.println("addMethod FunctionMethodDecl "+n.c.s.toString());
    
    if (!currClass.addMethod(id,t)){
	System.out.println("FunctionMethod " + id 
			   + " is already defined in " 
			   + currClass.getId()); 
	System.exit(-1);
    }
...
//        n.a.accept(this);                // Type
//        n.b.accept(this);                // Iden
        System.out.println("addVar LocalVariableDecl "+n.b.s.toString() );
     Type t =  n.a.accept(this);
     String id =  n.b.s.toString();
